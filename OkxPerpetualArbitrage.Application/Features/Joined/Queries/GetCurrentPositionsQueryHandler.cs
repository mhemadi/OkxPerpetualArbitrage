...
namespace OkxPerpetualArbitrage.Application.Features.Joined.Queries
{
    ...
    public class GetCurrentPositionsQueryHandler : IRequestHandler<GetCurrentPositionsQuery, List<CurrentPositionListItemDto>>
    {
        ...
        public GetCurrentPositionsQueryHandler(IPositionDemandRepository positionDemandRepository, IOrderFillRepository orderFillRepository, IPotentialPositionRepository potentialPositionRepository
            , IApiService apiService, IFundingIncomeRepository fundingIncomeRepository)
        {
